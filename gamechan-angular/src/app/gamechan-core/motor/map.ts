...
export class Map {
    ...
    private displayMap(){
        ...
        //Create the walls
        //N
        for(x = 0; x < this.mapWidth; x++) this.makeBlock(x,z,'./assets/textures/concrete_text.jpg');

        z =  this.mapHeight;
        for(x = 0; x < this.mapWidth; x++) this.makeBlock(x,z,'./assets/textures/concrete_text.jpg');

        x = 0;
        for(z = 0; z < this.mapHeight; z++) this.makeBlock(x,z,'./assets/textures/concrete_text.jpg');
    ...
    private makeBlock(x_,z_,text_){
        ...
        mesh.position.x = x_ * this.blockSize;
        mesh.position.z = z_ * this.blockSize;
